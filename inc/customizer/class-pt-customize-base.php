...
class BuildPress_Customizer_Base {
	...
	*/
	public function register () {
		...
		$this->wp_customize->add_setting( new BuildPress_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'header_bg_mobile', array(
			'default' => '#524639',
			'css_map' => array(
				'background-color' => array(
					'.header-transparent .header__container|@media (max-width: 991px)',
				),
			)
		) ) );
		...
		// fonts
		$this->wp_customize->add_setting( new BuildPress_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'primary_font', array(
		...
		$this->wp_customize->add_setting( new BuildPress_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'secondary_font', array(
			'default'         => 'Montserrat',
			'transport'       => 'refresh',
		...
		$this->wp_customize->add_setting( new BuildPress_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'primary_color', array(
			...
			'css_map' => array(
				...
				'border-color' => array(
					...
					'.header-transparent .navigation--main > li.is-hover > a|@media (min-width: 992px)',
					'.header-transparent .navigation--main > li:hover > a|@media (min-width: 992px)',
					'.header-transparent .navigation--main > .current-menu-item > a|@media (min-width: 992px)',
